      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center gap-8">
          <a
            ...
            className="group relative inline-flex items-center justify-center gap-3 px-10 py-6 text-lg font-semibold text-black bg-gradient-to-r from-primary to-accent rounded-full hover:shadow-2xl transform hover:scale-105 transition-all duration-300 ease-out"
          >
